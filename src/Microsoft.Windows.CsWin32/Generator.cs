...
"));
        ...
        {
            if (this.mr.StringComparer.Equals(interfaceTypeDef.Name, "IUnknown"))
            {
                return false;
            }
            ...
            InterfaceImplementation baseIFace = this.mr.GetInterfaceImplementation(firstBaseInterface);
            ...
            return this.IsNonCOMInterface(this.mr.GetTypeDefinition(baseIFaceTypeDefHandle));
        }
        ...
        private TypeDeclarationSyntax? DeclareInterfaceAsInterface(TypeDefinition typeDef, Stack<TypeDefinitionHandle> baseTypes)
        {
            ...
            while (baseTypes.Count > 0)
            {
                ...
                if (!foundIUnknown)
                {
                    if (!this.mr.StringComparer.Equals(baseType.Name, "IUnknown"))
                    {
                ...
                {
                    if (this.mr.StringComparer.Equals(baseType.Name, "IDispatch"))
                    {
                        foundIDispatch = true;
                    }
